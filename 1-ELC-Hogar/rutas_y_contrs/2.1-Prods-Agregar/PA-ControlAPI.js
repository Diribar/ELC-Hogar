...
module.exports = {
	validacs: {
		...
		desambiguar: async (req, res) => {
			...
			let errores = await validacsFM.datosDuros(camposNombre, datosDuros);
		...
		datosDuros: async (req, res) => {
			...
			let errores = await validacsFM.datosDuros(campos, datos);
		...
		datosAdics: async (req, res) => {
			...
			let errores = await validacsFM.datosAdics(campos, req.query);
			return res.json(errores);
		},
		copiarFA: (req, res) => {
