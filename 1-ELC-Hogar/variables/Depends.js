...
const prodsAsoc = ["pelicula", "coleccion", "capitulo"];
...
const rclvsAsoc = ["personaje", "hecho", "tema", "evento", "epocaDelAno"];
	...
	filtrosCons: {
			...
			opciones: [
				{
					...
					detRclv: {conLinks: "linksCast", conLinksHD: "HD_Cast"},
				},
				{
					id: "enCast",
					...
					detRclv: {conLinks: ["linksCast", "linksSubt"], conLinksHD: ["HD_Cast", "HD_Subt"]},
				},
		...
		publicos: {
			...
			opciones: [
				...
				{
					id: "MC",
					nombre: "Mayores o sin clasificar",
					condic: {publico_id: {[Op.or]: [null, ...mayores_ids]}},
					detRclv: [null, ...mayores_ids],
				}, // se debe escribir así: {[Op.or]: [null, ...mayores_ids]}
				{id: "FM", nombre: "Familia", condic: {publico_id: familia_ids}, detRclv: familia_ids},
				{id: "MN", nombre: "Menores", condic: {publico_id: menores_ids}, detRclv: menores_ids},
			],
		},
		cfc: {
